...
def process_audio_to_hls(
    ...
    *,
    ...
    # Ensure key directory exists before writing
    ...
    # Chrome (MSE) often refuses to play audio-only HLS. We insert a very small 16x16 black video track.
